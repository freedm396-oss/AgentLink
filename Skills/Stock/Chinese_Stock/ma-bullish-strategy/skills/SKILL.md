...
```bash
# 扫描全市场（自动选择最佳数据源）
python skills/scripts/analyzer.py --scan --top 20

# 指定数据源扫描
python skills/scripts/analyzer.py --source baostock --scan --top 10

# 分析单只股票
python skills/scripts/analyzer.py --stock 000001 --name 平安银行

# 指定数据源分析
python skills/scripts/analyzer.py --source baostock --stock 000001

# 分析指定日期
python skills/scripts/analyzer.py --stock 000001 --date 2026-04-03

# 指定数据源和日期
python skills/scripts/analyzer.py --source baostock --stock 000001 --date 2026-04-03

# 分析指定板块
python skills/scripts/analyzer.py --sector 科技 --date 2026-04-03
python skills/scripts/analyzer.py --sector 医药 --date 2026-04-03

# 分析所有板块
python skills/scripts/analyzer.py --all-sectors --date 2026-04-03
```
