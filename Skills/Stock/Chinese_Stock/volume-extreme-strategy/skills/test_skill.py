#!/usr/bin/env python3
"""volume-extreme-strategy 功能测试"""

import sys
sys.path.insert(0, '/home/qinliming/.npm-global/lib/node_modules/openclaw/skills/Stock/Chinese_Stock/volume-extreme-strategy')
...
try:
    import yaml
    with open('/home/qinliming/.npm-global/lib/node_modules/openclaw/skills/Stock/Chinese_Stock/volume-extreme-strategy/config/scoring_weights.yaml', 'r') as f:
