...
try:
    import yaml
    with open('/home/qinliming/.npm-global/lib/node_modules/openclaw/skills/Stock/Chinese_Stock/rsi-oversold-strategy/config/scoring_weights.yaml', 'r') as f:
